...
# TODO: napraviti funkcije za brisanje grana i cvorova
    ...
    if canvas_mode == 'dodaj_cvor':
        ...
        for (id, koordinate) in cvorovi.items():
            if abs(x-koordinate[0]) < 50 and abs(y-koordinate[1]) < 50:
                ...
                return
        cvor = canvas.create_oval(x-15, y-15, x+15, y+15, outline='red', fill='black')
        cvorovi[cvor] = (x, y)
            ...
            if abs(koordinate[0]-x) <= 15 and abs(koordinate[1]-y) <= 15:
                ...
                if grana_pocetak==0:
                    ...
                    if id == prvi_cvor:
                        ...
                        return
                    grana_pocetak=0
                    grana = canvas.create_line(cvorovi[prvi_cvor][0], cvorovi[prvi_cvor][1], koordinate[0], koordinate[1], width=2, fill='blue')
...
def main():
    ...
    button_reset = Button(root, text='Reset', command=reset, width=64)
    ...
    button_reset.grid(column = 3, row=4, columnspan=2)
